...
Checking into it, the smooth scroll event callback takes 20ms scrolling in one direction, and 3x longer in the other.  Perfectly fine for normal mice which deliver a few scrolling events a second.  /But trackpad scroll events are arriving every 15ms or less/!  The code just couldn't keep up.  Hence the molasses.
